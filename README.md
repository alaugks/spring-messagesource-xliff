...
|-------------------------------------------|----------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Inline formatting / code elements         | `<g/>`, `<x/>`, `<bx/>`, `<ex/>`, `<bpt/>`, `<ept/>`, `<ph/>`, `<it/>`, `<sub/>` | `<pc/>`, `<ph/>`, `<sc/>`, `<ec/>`, `<cp/>`                                                                                   | ⚠️ [Work in progress.](https://github.com/alaugks/spring-messagesource-xliff/tree/snapshot/4.x-inline-formatting-placeholder)<br><br>Not interpreted. Text-wrapping elements keep their text; standalone placeholders contribute nothing. Use `CDATA` for display markup (see [Markup](#markup)). |
| Placeholder / original-data fallback text | `equiv-text`                                                                     | `equiv`, `disp`, `<originalData/>` + `dataRef`                                                                                | ⚠️ [Work in progress.](https://github.com/alaugks/spring-messagesource-xliff/tree/snapshot/4.x-inline-formatting-placeholder)<br><br>Ignored; native code is not reconstructed.                                                                                                                   |
