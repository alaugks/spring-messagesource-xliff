...
|-------------------------------------------|----------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Inline formatting / code elements         | `<g/>`, `<x/>`, `<bx/>`, `<ex/>`, `<bpt/>`, `<ept/>`, `<ph/>`, `<it/>`, `<sub/>` | `<pc/>`, `<ph/>`, `<sc/>`, `<ec/>`, `<cp/>`                                                                                   | Reconstructed as text (prototype, see [Markup](#markup)); `<sm/>`/`<em/>` ignored. `<bpt/>`, `<ept/>`, `<it/>`, `<sub/>` keep their content. |
| Placeholder / original-data fallback text | `equiv-text`                                                                     | `equiv`, `disp`, `<originalData/>` + `dataRef`                                                                                | Used: `<originalData/>` via `dataRef`, else `equiv` / `equiv-text`. `disp` is ignored. |
