...
[![Maven Central](https://img.shields.io/maven-central/v/io.github.alaugks/spring-messagesource-xliff.svg?label=Maven%20Central)](https://central.sonatype.com/artifact/io.github.alaugks/spring-messagesource-xliff/4.2.0-inline-SNAPSHOT)
...
<dependency>
    ...
    <version>4.2.0-inline-SNAPSHOT</version>
</dependency>
```
...
```text
implementation group: 'io.github.alaugks', name: 'spring-messagesource-xliff', version: '4.2.0-inline-SNAPSHOT'
```
