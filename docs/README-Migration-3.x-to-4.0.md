...
| `Builder.domainDivider(String)` *(deprecated since 4.0.0)* | Separator used between domain and code when the file's domain differed from the default domain. Default was `"."`.                                                                               |
